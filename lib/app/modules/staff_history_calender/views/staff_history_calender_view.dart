...
class StaffHistoryCalenderView extends GetView<StaffHistoryCalenderController> {
          ...
          Expanded(
            ...
            itemBuilder: (context, index) {
              return _buildOrderCard(
                  context); // Call the method to build each order card
            },
          )),
        ],
      ),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                //     shape: BoxShape.rectangle, // Circle shape for the container
