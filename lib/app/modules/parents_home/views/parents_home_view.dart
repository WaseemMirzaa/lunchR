              ...
              children: [
                ...
                Obx(
                  () => Column(
                    children: [
                      Text(
                        "\$${controller.parentAddWalletModel.value?.amount}",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AdvancedSwitch(
                            ...
                            height: 12,
                            onChanged: (val) {
                              controller.toggleMonthlyReload(val);
                            },
                            initialValue: controller.parentAddWalletModel.value?.enableMonthlyReload ?? false,
                          )
                        ],
                      ),
                    ],
                ...
                Obx(
                  () => Expanded(
                      child: ListView.separated(
                          itemCount: controller.childrenList.length, // Display 4 items
                          ...
                          itemBuilder: (context, index) {
                            return WalletBalanceCard(
                              ...
                              isDeliveredBy: false,
                              isStaff: false,
                              childList: controller.childrenList[index], // Pass each child object
                            );
                          })),
                ),
